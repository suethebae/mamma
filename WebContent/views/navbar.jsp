    ...
    <ul class="navbar__menu">
      ...
      <li class="navbar__menu__item"><a href="/item/list">SHOP</a></li>
		...
		<ul class="navbar__sidemenu">
			...
			%>
			<li class="navbar__sidemenu__item"><a href='/mymenu/myPage'>MY MENU</a></li>
...
<div class="navbar__mobile">
      <div><span style="font-size:20px;cursor:pointer" onclick="openNav()"><i class="fas fa-bars"
            id="navbar__toggle-btn"></i></span></div>
      <div><img src="/views/img/logo.png" alt="logo"/></div>
      <div><i class="fas fa-shopping-cart" style="font-size: 20px;"></i></div>
    </div>
      ...
      <div class="overlay-content">
        <div class="mnavbar__sidemenu">
			<%
				if (member_sq == null) {
			%>
			<a class="navbar__sidemenu__item" href="/member/login">LOGIN</a>
			<a class="navbar__sidemenu__item" href="/member/register">JOIN</a>
			<a class="navbar__sidemenu__item" href="/cart/list">CART</a>
			<%
				} else {
			%>
			<a class="navbar__sidemenu__item" href='/mymenu/myPage'>MY MENU</a>
			<a class="navbar__sidemenu__item" href="/member/logout">LOGOUT</a>
			<a class="navbar__sidemenu__item" href="/cart/list">CART</a>
			<%
				}
			%>
      	...
      	<div class="mnavbar__menu">
        	...
        	<a class="mnavber__menu__item" href="/">ABOUT</a>
        	<a class="mnavber__menu__item" href="/">CONTACT</a>
        </div>
      </div>
    </div>
</header>
