...
<body>
	<form action="/actgry/modifyProc" method="post"
		onsubmit="return modifyProc()">
		<div>
			카테고리 번호 <input type="text" id="ctgry_sq" name="ctgry_sq"
				value="<%=actgryVo.getCtgry_sq()%>" readonly="readonly" />
		</div>
		<div>
			카테고리 이름<input type="text" id="nm" name="nm"
				value="<%=actgryVo.getNm()%>" />
		</div>
		<div>
