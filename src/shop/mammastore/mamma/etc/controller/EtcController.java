package shop.mammastore.mamma.etc.controller;
...
import shop.mammastore.mamma.etc.action.AboutAction;
import shop.mammastore.mamma.etc.action.ContactAction;
...
public class EtcController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		String command = requestURI.substring(contextPath.length()).replaceAll("/etc", "");// 여기에 우리가 들고올 마지막 경로를 가져온다
